...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("CGV Catalog Service API")
                        .version("1.0.0")
                        .description("Tài liệu API quản lý danh mục phim, cụm rạp, phòng chiếu, lịch chiếu, sơ đồ ghế và tìm kiếm Elasticsearch.")
                        .contact(new Contact()
                                .name("CGV Tech Team")
                                .email("dev@cgv.vn"))
                        .license(new License()
                ...
                .servers(List.of(
                        ...
                        new Server()
                                ...
                                .description("Chế độ 2: Trực tiếp Port chính Service (Local 8083)")
                ))
