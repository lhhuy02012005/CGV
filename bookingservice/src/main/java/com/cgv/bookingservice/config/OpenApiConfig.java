...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("CGV Booking Service API")
                        .version("1.0.0")
                        .description("Tài liệu API đặt vé xem phim, giữ ghế thời gian thực (Redis Lock), WebSocket ghế và quản lý đơn đặt vé.")
                        .contact(new Contact()
                                .name("CGV Tech Team")
                                .email("dev@cgv.vn"))
                        .license(new License()
                ...
                .servers(List.of(
                        ...
                        new Server()
                                ...
                                .description("Chế độ 2: Trực tiếp Port chính Service (Local 8082)")
                ))
