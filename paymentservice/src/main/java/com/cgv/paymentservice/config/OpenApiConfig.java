...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("CGV Payment Service API")
                        .version("1.0.0")
                        .description("Tài liệu API tích hợp cổng thanh toán VNPay, xác thực chữ ký số, xử lý Webhook và cập nhật trạng thái đơn.")
                        .contact(new Contact()
                                .name("CGV Tech Team")
                                .email("dev@cgv.vn"))
                        .license(new License()
                ...
                .servers(List.of(
                        ...
                        new Server()
                                ...
                                .description("Chế độ 2: Trực tiếp Port chính Service (Local 8085)")
                ))
